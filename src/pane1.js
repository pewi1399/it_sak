  ...
  var x = d3.scaleLinear()
	...
	z.domain(stratas.map(function(s) { return s.id; }));
	...
	var survline = g.selectAll(".survline")
	 .data(stratas)
	 .enter().append("g")
	   .attr("class", "survline");
...
// function for intersection markers
        d3.selectAll(".mouse-per-line")
          .attr("transform", function(d, i) {
            ...
            d3.selectAll(".legend:nth-child("+(3 + i)+")").select("text").text(pos.y)
